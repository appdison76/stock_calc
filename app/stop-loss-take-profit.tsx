        ...
        <View style={styles.card}>
          ...
          <View style={styles.percentRow}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                togglePlainPercentSign(takeProfitRate, (next) =>
                  handleProfitRateInputChange(next, setTakeProfitRate)
                )
              }
              activeOpacity={0.75}
          ...
          <View style={styles.percentRow}>
            ...
            <TouchableOpacity
              style={styles.signToggleBtn}
              onPress={() =>
                togglePlainPercentSign(stopLossRate, (next) =>
                  handleProfitRateInputChange(next, setStopLossRate)
                )
              }
              activeOpacity={0.75}
              accessibilityLabel="부호 바꾸기"
